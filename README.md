...
│  │  • Estimate speakers, select Whisper model│   │
│  └──────────────────┬────────────────────────┘   │
│                     ▼                            │
│  ┌───────────────────────────────────────────┐   │
...
│   ├── transcriber.py      # Whisper transcription + speaker segmentation
...
Speaker 2 raised concerns about resource allocation across
two parallel workstreams...

ACTION ITEMS
------------
[ ] Speaker 1 — Send updated project timeline       (by Friday)
[ ] Speaker 2 — Schedule follow-up with design team (by Monday)
[ ] Speaker 3 — Review and approve budget proposal  (by EOD)
...
NEXT STEPS
----------
Follow-up meeting to be scheduled by Speaker 1.
========================================
Generated by MOMentum
